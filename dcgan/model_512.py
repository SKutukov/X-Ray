...
class netG(nn.Module):
    def __init__(self, ngpu, nz, ngf, nc):
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=ngf * 64, out_channels=ngf * 32, kernel_size=4, stride=1, padding=0, bias=False),
...
class netD(nn.Module):
    def __init__(self, ngpu, nc, ndf):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv2d(in_channels=ndf * 32, out_channels=ndf * 64, kernel_size=4, stride=2, padding=1, bias=False),
